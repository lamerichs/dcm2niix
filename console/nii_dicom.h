...
static const int kMaxDTI4D = 65000; //maximum number of DTI directions for 4D (Philips) images, also maximum number of 3D slices for Philips 3D and 4D images
static const int kMaxSlice2D = 65000; //maximum number of 2D slices in 4D (Philips) images
